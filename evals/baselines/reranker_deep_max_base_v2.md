# Retriever Baseline: reranker_deep_max_base_v2
...
- Strategy：`reranker_deep_max_base`
- Strategy parameters：`{'candidate_pool_size': 50, 'rrf_k': 60, 'fusion': 'max_over_query', 'query_rewrite': True, 'reranker': False}`
- First query / subsequent mean：1511.46 / 1436.93 ms
- P50 / P95 / Max latency：1415.96 / 1700.1 / 1972.56 ms
