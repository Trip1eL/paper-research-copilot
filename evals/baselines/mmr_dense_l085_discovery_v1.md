# Retriever Baseline: mmr_dense_l085_discovery_v1
...
- First query / subsequent mean：465.99 / 258.17 ms
- P50 / P95 / Max latency：254.11 / 322.78 / 465.99 ms
...
| 3 | 100.00% | 98.00% | 96.00% | 88.00% | 82.00% | 76.00% | 1.33% |
| 5 | 100.00% | 98.00% | 96.00% | 92.00% | 86.00% | 80.00% | 4.80% |
| 10 | 100.00% | 100.00% | 100.00% | 100.00% | 94.00% | 88.00% | 6.80% |

- Paper MRR@10：0.9800
- Exact Page MRR@10：0.7647

## 初步观察

- Top-10 Paper Recall 为 100.00%；完整覆盖率为 100.00%。
- Top-10 Exact Page Recall 为 94.00%；该指标受非穷举页码标注影响，是严格下界。
- Top-10 Same-page Redundancy 为 6.80%。
- 从 Top-5 增加到 Top-10，Paper Recall 变化 +2.00%，Exact Page Recall 变化 +8.00%，同页冗余变化 +2.00%。
...
| fact | 6 | 100.00% | 100.00% | 100.00% | 1.0000 | 0.7208 |
| method | 14 | 100.00% | 100.00% | 100.00% | 0.9643 | 0.7351 |

## 按难度

| Group | Cases | Paper Recall | Complete Papers | Exact Page Recall | Paper MRR | Page MRR |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| hard | 11 | 100.00% | 100.00% | 86.36% | 1.0000 | 0.8144 |
| medium | 14 | 100.00% | 100.00% | 100.00% | 0.9643 | 0.7256 |

## 未完整覆盖的 Case

- Paper@10：无
- Exact Page@10：DS-021, DS-022, DS-023
...
| DS-020 | method | arxiv:2308.03688 | 1 | 0.5941 | True | True |
