# Retriever Baseline: dense_discovery_v1
...
- Strategy：`dense`
- Strategy parameters：`{}`
- First query / subsequent mean：523.21 / 229.66 ms
- P50 / P95 / Max latency：229.86 / 268.75 / 523.21 ms
...
| 3 | 100.00% | 94.00% | 88.00% | 88.00% | 82.00% | 76.00% | 8.00% |
| 5 | 100.00% | 98.00% | 96.00% | 96.00% | 90.00% | 84.00% | 8.80% |
| 10 | 100.00% | 98.00% | 96.00% | 100.00% | 96.00% | 92.00% | 13.60% |

- Paper MRR@10：0.9733
- Exact Page MRR@10：0.7543

## 初步观察

- Top-10 Paper Recall 为 98.00%；完整覆盖率为 96.00%。
- Top-10 Exact Page Recall 为 96.00%；该指标受非穷举页码标注影响，是严格下界。
- Top-10 Same-page Redundancy 为 13.60%。
- 从 Top-5 增加到 Top-10，Paper Recall 变化 +0.00%，Exact Page Recall 变化 +6.00%，同页冗余变化 +4.80%。
...
| method | 14 | 100.00% | 100.00% | 100.00% | 0.9524 | 0.7167 |

## 按难度

| Group | Cases | Paper Recall | Complete Papers | Exact Page Recall | Paper MRR | Page MRR |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| hard | 11 | 95.45% | 90.91% | 90.91% | 1.0000 | 0.8144 |
| medium | 14 | 100.00% | 100.00% | 100.00% | 0.9524 | 0.7071 |
...
| DS-013 | method | arxiv:2305.16291 | 3 | 0.5751 | True | True |
