# Retriever Baseline: query_fusion_flat_sum_v2
...
- Strategy：`flat_sum_rrf`
- Strategy parameters：`{'candidate_pool_size': 50, 'rrf_k': 60, 'shared_branch_rankings': True, 'fusion_mean_ms': 0.3973, 'rewrite_model': 'deepseek-v4-flash', 'rewrite_prompt_version': 'query_rewrite_v1', 'rewrite_title_leak_hits': 0}`
- First query / subsequent mean：1570.09 / 1427.83 ms
- P50 / P95 / Max latency：1403.07 / 1674.68 / 1961.39 ms
...
| DS-018 | method | arxiv:2308.08155 | 3 | 0.1081 | True | True |
| DS-019 | fact | arxiv:2308.03688 | 1 | 0.1080 | True | True |
| DS-020 | method | arxiv:2308.03688 | 3 | 0.0971 | True | True |
...
| DS-031 | method | arxiv:2305.15334 | 2 | 0.1250 | True | True |
