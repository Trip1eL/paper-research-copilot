...
- Strategy：`dense`
- Strategy parameters：`{}`
- First query / subsequent mean：484.29 / 238.97 ms
- P50 / P95 / Max latency：241.35 / 268.37 / 484.29 ms
...
| 3 | 100.00% | 98.00% | 96.00% | 84.00% | 80.00% | 76.00% | 8.00% |
| 5 | 100.00% | 98.00% | 96.00% | 88.00% | 82.00% | 76.00% | 10.40% |
| 10 | 100.00% | 98.00% | 96.00% | 92.00% | 86.00% | 80.00% | 19.60% |

- Paper MRR@10：0.9733
- Exact Page MRR@10：0.7670

## 初步观察

- Top-10 Paper Recall 为 98.00%；完整覆盖率为 96.00%。
- Top-10 Exact Page Recall 为 86.00%；该指标受非穷举页码标注影响，是严格下界。
- Top-10 Same-page Redundancy 为 19.60%。
- 从 Top-5 增加到 Top-10，Paper Recall 变化 +0.00%，Exact Page Recall 变化 +4.00%，同页冗余变化 +9.20%。

## 按问题类型

| Group | Cases | Paper Recall | Complete Papers | Exact Page Recall | Paper MRR | Page MRR |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| cross_paper | 5 | 90.00% | 80.00% | 70.00% | 1.0000 | 0.6686 |
| fact | 6 | 100.00% | 100.00% | 100.00% | 1.0000 | 0.7500 |
| method | 14 | 100.00% | 100.00% | 85.71% | 0.9524 | 0.8095 |
...
| hard | 5 | 90.00% | 80.00% | 70.00% | 1.0000 | 0.6686 |
| medium | 12 | 100.00% | 100.00% | 83.33% | 0.9444 | 0.6944 |

## 未完整覆盖的 Case

- Paper@10：RD-024
- Exact Page@10：RD-004, RD-016, RD-021, RD-022, RD-024
