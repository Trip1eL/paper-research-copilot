# Retriever Baseline: diversified_dense_discovery_v1
...
- Strategy：`diversified_dense`
- Strategy parameters：`{'candidate_pool_size': 50, 'max_chunks_per_paper': 3, 'max_chunks_per_page': 1}`
- First query / subsequent mean：487.61 / 239.6 ms
- P50 / P95 / Max latency：237.69 / 286.33 / 487.61 ms
...
| 3 | 100.00% | 98.00% | 96.00% | 88.00% | 82.00% | 76.00% | 0.00% |
| 5 | 100.00% | 98.00% | 96.00% | 92.00% | 86.00% | 80.00% | 0.00% |
| 10 | 100.00% | 100.00% | 100.00% | 92.00% | 86.00% | 80.00% | 0.00% |

- Paper MRR@10：0.9733
- Exact Page MRR@10：0.7433

## 初步观察

- Top-10 Paper Recall 为 100.00%；完整覆盖率为 100.00%。
- Top-10 Exact Page Recall 为 86.00%；该指标受非穷举页码标注影响，是严格下界。
- Top-10 Same-page Redundancy 为 0.00%。
- 从 Top-5 增加到 Top-10，Paper Recall 变化 +2.00%，Exact Page Recall 变化 +0.00%，同页冗余变化 +0.00%。
...
| fact | 6 | 100.00% | 100.00% | 66.67% | 1.0000 | 0.6667 |
| method | 14 | 100.00% | 100.00% | 100.00% | 0.9524 | 0.7202 |

## 按难度

| Group | Cases | Paper Recall | Complete Papers | Exact Page Recall | Paper MRR | Page MRR |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| hard | 11 | 100.00% | 100.00% | 77.27% | 1.0000 | 0.8030 |
| medium | 14 | 100.00% | 100.00% | 92.86% | 0.9524 | 0.6964 |

## 未完整覆盖的 Case

- Paper@10：无
- Exact Page@10：DS-003, DS-008, DS-021, DS-022, DS-023
...
| DS-002 | fact | arxiv:2210.03629 | 4 | 0.5890 | True | True |
...
| DS-008 | fact | arxiv:2310.04406 | 16 | 0.6033 | True | False |
...
| DS-013 | method | arxiv:2305.16291 | 3 | 0.5745 | True | True |
| DS-014 | method | arxiv:2305.16291 | 2 | 0.6294 | True | True |
| DS-015 | method | arxiv:2303.17760 | 5 | 0.6850 | True | False |
