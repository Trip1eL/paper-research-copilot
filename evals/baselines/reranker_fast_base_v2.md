# Retriever Baseline: reranker_fast_base_v2
...
- Strategy：`reranker_fast_base`
- Strategy parameters：`{'candidate_pool_size': 50, 'rrf_k': 60, 'fusion': 'original_query_rrf', 'query_rewrite': False, 'reranker': False}`
- First query / subsequent mean：441.67 / 364.31 ms
- P50 / P95 / Max latency：349.27 / 479.11 / 566.56 ms
