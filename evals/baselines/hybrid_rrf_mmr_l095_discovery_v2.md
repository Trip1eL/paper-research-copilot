# Retriever Baseline: hybrid_rrf_mmr_l095_discovery_v2
...
- Strategy parameters：`{'bm25_k1': 1.5, 'bm25_b': 0.75, 'tokenizer': 'english_stopwords_porter_stemmer', 'candidate_pool_size': 50, 'rrf_k': 60, 'lambda_mult': 0.95, 'rrf_score_normalization': 'min_max'}`
- First query / subsequent mean：532.54 / 364.25 ms
- P50 / P95 / Max latency：357.27 / 438.3 / 604.22 ms
...
| 3 | 98.00% | 87.83% | 78.00% | 90.00% | 76.83% | 64.00% | 8.00% |
| 5 | 100.00% | 92.33% | 84.00% | 92.00% | 80.83% | 70.00% | 12.00% |
| 10 | 100.00% | 95.83% | 90.00% | 100.00% | 91.83% | 82.00% | 15.60% |

- Paper MRR@10：0.9640
- Exact Page MRR@10：0.8103

## 初步观察

- Top-10 Paper Recall 为 95.83%；完整覆盖率为 90.00%。
- Top-10 Exact Page Recall 为 91.83%；该指标受非穷举页码标注影响，是严格下界。
- Top-10 Same-page Redundancy 为 15.60%。
- 从 Top-5 增加到 Top-10，Paper Recall 变化 +3.50%，Exact Page Recall 变化 +11.00%，同页冗余变化 +3.60%。
...
| method | 26 | 100.00% | 100.00% | 100.00% | 1.0000 | 0.8558 |

## 按难度

| Group | Cases | Paper Recall | Complete Papers | Exact Page Recall | Paper MRR | Page MRR |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| hard | 36 | 94.21% | 86.11% | 88.66% | 0.9722 | 0.8148 |
...
| paired_anchor | 25 | 98.00% | 96.00% | 96.00% | 0.9680 | 0.8073 |
