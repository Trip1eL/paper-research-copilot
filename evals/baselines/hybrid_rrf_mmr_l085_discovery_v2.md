# Retriever Baseline: hybrid_rrf_mmr_l085_discovery_v2
...
- First query / subsequent mean：440.68 / 404.1 ms
- P50 / P95 / Max latency：368.78 / 611.67 / 683.24 ms
...
| 3 | 98.00% | 87.83% | 78.00% | 90.00% | 77.17% | 66.00% | 7.33% |
| 5 | 100.00% | 92.33% | 84.00% | 92.00% | 80.83% | 70.00% | 11.60% |
| 10 | 100.00% | 95.83% | 90.00% | 100.00% | 91.83% | 82.00% | 15.00% |

- Paper MRR@10：0.9640
- Exact Page MRR@10：0.8094

## 初步观察

- Top-10 Paper Recall 为 95.83%；完整覆盖率为 90.00%。
- Top-10 Exact Page Recall 为 91.83%；该指标受非穷举页码标注影响，是严格下界。
- Top-10 Same-page Redundancy 为 15.00%。
- 从 Top-5 增加到 Top-10，Paper Recall 变化 +3.50%，Exact Page Recall 变化 +11.00%，同页冗余变化 +3.40%。

## 按问题类型

| Group | Cases | Paper Recall | Complete Papers | Exact Page Recall | Paper MRR | Page MRR |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| cross_paper | 15 | 86.11% | 66.67% | 72.78% | 0.9667 | 0.7984 |
| fact | 9 | 100.00% | 100.00% | 100.00% | 0.8556 | 0.6751 |
...
| Group | Cases | Paper Recall | Complete Papers | Exact Page Recall | Paper MRR | Page MRR |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| hard | 36 | 94.21% | 86.11% | 88.66% | 0.9722 | 0.8089 |
| medium | 14 | 100.00% | 100.00% | 100.00% | 0.9429 | 0.8107 |

## 按 Evaluation Split

| Group | Cases | Paper Recall | Complete Papers | Exact Page Recall | Paper MRR | Page MRR |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| challenge | 25 | 93.67% | 84.00% | 87.67% | 0.9600 | 0.8048 |
| paired_anchor | 25 | 98.00% | 96.00% | 96.00% | 0.9680 | 0.8140 |
