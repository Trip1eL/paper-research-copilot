# Retriever Baseline: diversified_dense_p4_discovery_v1
...
- Strategy parameters：`{'candidate_pool_size': 50, 'max_chunks_per_paper': 4, 'max_chunks_per_page': 1}`
- First query / subsequent mean：470.12 / 233.99 ms
- P50 / P95 / Max latency：236.09 / 300.61 / 470.12 ms
...
| 5 | 100.00% | 98.00% | 96.00% | 96.00% | 90.00% | 84.00% | 0.00% |
| 10 | 100.00% | 98.00% | 96.00% | 96.00% | 92.00% | 88.00% | 0.00% |

- Paper MRR@10：0.9733
- Exact Page MRR@10：0.7513

## 初步观察

- Top-10 Paper Recall 为 98.00%；完整覆盖率为 96.00%。
- Top-10 Exact Page Recall 为 92.00%；该指标受非穷举页码标注影响，是严格下界。
- Top-10 Same-page Redundancy 为 0.00%。
- 从 Top-5 增加到 Top-10，Paper Recall 变化 +0.00%，Exact Page Recall 变化 +2.00%，同页冗余变化 +0.00%。

## 按问题类型

| Group | Cases | Paper Recall | Complete Papers | Exact Page Recall | Paper MRR | Page MRR |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| cross_paper | 5 | 90.00% | 80.00% | 80.00% | 1.0000 | 0.9000 |
| fact | 6 | 100.00% | 100.00% | 83.33% | 1.0000 | 0.7000 |
...
| Group | Cases | Paper Recall | Complete Papers | Exact Page Recall | Paper MRR | Page MRR |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| hard | 11 | 95.45% | 90.91% | 81.82% | 1.0000 | 0.8030 |
| medium | 14 | 100.00% | 100.00% | 100.00% | 0.9524 | 0.7107 |

## 未完整覆盖的 Case

- Paper@10：DS-021
- Exact Page@10：DS-008, DS-021, DS-022
...
| DS-007 | method | arxiv:2310.04406 | 4 | 0.6421 | True | True |
