# Retriever Baseline: query_fusion_no_rewrite_v2
...
- Strategy：`no_rewrite`
- Strategy parameters：`{'candidate_pool_size': 50, 'rrf_k': 60, 'shared_branch_rankings': True, 'fusion_mean_ms': 0.2035, 'rewrite_model': 'deepseek-v4-flash', 'rewrite_prompt_version': 'query_rewrite_v1', 'rewrite_title_leak_hits': 0}`
- First query / subsequent mean：484.5 / 369.44 ms
- P50 / P95 / Max latency：352.81 / 484.5 / 789.42 ms
...
| 3 | 98.00% | 87.83% | 78.00% | 90.00% | 76.83% | 64.00% | 8.67% |
| 5 | 100.00% | 92.33% | 84.00% | 92.00% | 80.83% | 70.00% | 12.40% |
| 10 | 100.00% | 95.83% | 90.00% | 100.00% | 91.83% | 82.00% | 15.20% |

- Paper MRR@10：0.9640
- Exact Page MRR@10：0.8099

## 初步观察

- Top-10 Paper Recall 为 95.83%；完整覆盖率为 90.00%。
- Top-10 Exact Page Recall 为 91.83%；该指标受非穷举页码标注影响，是严格下界。
- Top-10 Same-page Redundancy 为 15.20%。
- 从 Top-5 增加到 Top-10，Paper Recall 变化 +3.50%，Exact Page Recall 变化 +11.00%，同页冗余变化 +2.80%。

## 按问题类型

| Group | Cases | Paper Recall | Complete Papers | Exact Page Recall | Paper MRR | Page MRR |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| cross_paper | 15 | 86.11% | 66.67% | 72.78% | 0.9667 | 0.8111 |
| fact | 9 | 100.00% | 100.00% | 100.00% | 0.8556 | 0.6778 |
| method | 26 | 100.00% | 100.00% | 100.00% | 1.0000 | 0.8549 |

## 按难度

| Group | Cases | Paper Recall | Complete Papers | Exact Page Recall | Paper MRR | Page MRR |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| hard | 36 | 94.21% | 86.11% | 88.66% | 0.9722 | 0.8142 |
| medium | 14 | 100.00% | 100.00% | 100.00% | 0.9429 | 0.7988 |

## 按 Evaluation Split

| Group | Cases | Paper Recall | Complete Papers | Exact Page Recall | Paper MRR | Page MRR |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| challenge | 25 | 93.67% | 84.00% | 87.67% | 0.9600 | 0.8133 |
| paired_anchor | 25 | 98.00% | 96.00% | 96.00% | 0.9680 | 0.8064 |

## 未完整覆盖的 Case

- Paper@10：DS-021, DS-041, DS-045, DS-046, DS-049
- Exact Page@10：DS-021, DS-022, DS-041, DS-044, DS-045, DS-046, DS-047, DS-049, DS-050
