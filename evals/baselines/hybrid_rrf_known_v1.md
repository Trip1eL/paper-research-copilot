# Retriever Baseline: hybrid_rrf_known_v1
...
- First query / subsequent mean：414.32 / 232.18 ms
- P50 / P95 / Max latency：233.48 / 264.57 / 414.32 ms
...
| 5 | 100.00% | 92.00% | 84.00% | 80.00% | 76.00% | 72.00% | 12.80% |
| 10 | 100.00% | 96.00% | 92.00% | 88.00% | 84.00% | 80.00% | 17.60% |
...
- Top-10 Paper Recall 为 96.00%；完整覆盖率为 92.00%。
- Top-10 Exact Page Recall 为 84.00%；该指标受非穷举页码标注影响，是严格下界。
- Top-10 Same-page Redundancy 为 17.60%。
- 从 Top-5 增加到 Top-10，Paper Recall 变化 +4.00%，Exact Page Recall 变化 +8.00%，同页冗余变化 +4.80%。

## 按问题类型

| Group | Cases | Paper Recall | Complete Papers | Exact Page Recall | Paper MRR | Page MRR |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| cross_paper | 5 | 80.00% | 60.00% | 60.00% | 1.0000 | 0.3050 |
...
| hard | 5 | 80.00% | 60.00% | 60.00% | 1.0000 | 0.3050 |
| medium | 12 | 100.00% | 100.00% | 83.33% | 0.9583 | 0.6994 |

## 未完整覆盖的 Case

- Paper@10：RD-022, RD-024
