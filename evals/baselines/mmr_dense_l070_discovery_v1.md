# Retriever Baseline: mmr_dense_l070_discovery_v1
...
- First query / subsequent mean：612.13 / 281.18 ms
- P50 / P95 / Max latency：271.09 / 407.14 / 612.13 ms
...
| 3 | 100.00% | 98.00% | 96.00% | 88.00% | 78.00% | 68.00% | 0.00% |
| 5 | 100.00% | 100.00% | 100.00% | 88.00% | 82.00% | 76.00% | 0.00% |
| 10 | 100.00% | 100.00% | 100.00% | 88.00% | 82.00% | 76.00% | 2.00% |

- Paper MRR@10：0.9800
- Exact Page MRR@10：0.7467

## 初步观察

- Top-10 Paper Recall 为 100.00%；完整覆盖率为 100.00%。
- Top-10 Exact Page Recall 为 82.00%；该指标受非穷举页码标注影响，是严格下界。
- Top-10 Same-page Redundancy 为 2.00%。
- 从 Top-5 增加到 Top-10，Paper Recall 变化 +0.00%，Exact Page Recall 变化 +0.00%，同页冗余变化 +2.00%。
...
| fact | 6 | 100.00% | 100.00% | 83.33% | 1.0000 | 0.7222 |
| method | 14 | 100.00% | 100.00% | 85.71% | 0.9643 | 0.7024 |

## 按难度

| Group | Cases | Paper Recall | Complete Papers | Exact Page Recall | Paper MRR | Page MRR |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| hard | 11 | 100.00% | 100.00% | 77.27% | 1.0000 | 0.8182 |
| medium | 14 | 100.00% | 100.00% | 85.71% | 0.9643 | 0.6905 |
...
| DS-010 | method | arxiv:2310.08560 | 1 | 0.6208 | True | True |
| DS-011 | method | arxiv:2304.03442 | 2 | 0.6207 | True | True |
| DS-012 | fact | arxiv:2304.03442 | 15 | 0.5575 | True | True |
| DS-013 | method | arxiv:2305.16291 | 3 | 0.5741 | True | True |
| DS-014 | method | arxiv:2305.16291 | 2 | 0.6292 | True | True |
...
| DS-018 | method | arxiv:2308.08155 | 2 | 0.6335 | True | False |
...
| DS-024 | cross_paper | arxiv:2303.17760 | 5 | 0.6368 | True | False |
| DS-025 | cross_paper | arxiv:2305.16291 | 3 | 0.5835 | True | True |
